...
pub fn relocate_pe_mem_with_per_sections(
    ...
    let res =
        relocate_with_per_section(image_buffer, loaded_buffer, new_image_base, section_closures).unwrap();
...
impl Section {
    ...
    pub fn return_section_virtual_address(&self) -> u32 {
        self.virtual_address
    }

    pub fn return_section_size(&self) -> u32 {
...
mod test {
    ...
    fn test_is_pe() {
        let image_bytes =
            include_bytes!("../../target/x86_64-unknown-uefi/release/rust-td-payload.efi");
